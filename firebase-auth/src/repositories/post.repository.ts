...
class PostRepository implements IPostRepository {
  ...
  public async getUserPosts(authorUID: string): Promise<ApiResponse<Post[]>> {
    try {
      const q = query(this.postsCollection, where('authorUID', '==', authorUID), orderBy('createdAt', 'desc'));
